...
(function($) {
  $(document).ready(function() {
    ...
    var overlay_panel_url = WPULRS.siteurl + '/wp-content/plugins/perfecto/panel.php';
    ...
    var init_perfecto = function() {
      ...
      (function() {
          ...
          $('#perfecto__imageoverlaycontrols-files').change(function() {
            ...
            filename_full = WPULRS.siteurl + '/wp-content/uploads/perfecto/' + filename;
            overlay.attr('src', filename_full);
            $.cookie('overlay_filename', filename);
          });

          var filename_full = WPULRS.siteurl + '/wp-content/uploads/perfecto/' + filename;
